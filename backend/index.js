...
const { videoUpload, convertVideoToBase64, convertFromBase64ToMp4 } = require('./modules/videoProcessing');
...
// GET VIDEO BY ID getVideoById
app.get('/video/:id/', (req, res) => getVideoById(req, res, connection));
